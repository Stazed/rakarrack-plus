...
def remap(efxindex, paramindex):
    return{
         ...
         (0, 0) : (1, '31 Hz', 'HZ31', -64) ,
         (0, 1) : (2, '63 Hz', 'HZ63', -64) ,
         (0, 2) : (3, '125 Hz', 'HZ125', -64) ,
         (0, 3) : (4, '250 Hz', 'HZ250', -64) ,
         (0, 4) : (5, '500 Hz', 'HZ500', -64) ,
         (0, 5) : (6, '1 kHz', 'KHZ1', -64) ,
         (0, 6) : (7, '2 kHz', 'KHZ2', -64) ,
         (0, 7) : (8, '4 kHz', 'KHZ4', -64) ,
         (0, 8) : (9, '8 kHz', 'KHZ8', -64) ,
         (0, 9) : (10, '16 kHz', 'KHZ16', -64) ,
         (0, 10) : (11, 'Gain', 'GAIN', -64) ,
         (0, 11) : (12, 'Q', 'Q', -64) ,
         (0, 12) : (-1,) ,
         ...
         (9, 0) : (1, 'Frequency', 'LFREQ', 0) ,
         (9, 1) : (2, 'Gain', 'LGAIN', -64) ,
         (9, 2) : (3, 'Width', 'LQ', -64) ,
         (9, 3) : (4, 'Frequency', 'MFREQ', 0) ,
         (9, 4) : (5, 'Gain', 'MGAIN', -64) ,
         (9, 5) : (6, 'Width', 'MQ', -64) ,
         (9, 6) : (7, 'Frequency', 'HFREQ', 0) ,
         (9, 7) : (8, 'Gain', 'HGAIN', -64) ,
         (9, 8) : (9, 'Width', 'HQ', -64) ,
         (9, 9) : (10, 'Gain', 'GAIN', -64) ,
         (9, 10) : (-1,) ,
