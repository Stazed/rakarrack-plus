...
Dflange::setpreset (int npreset)
{
  ...
  int presets[NUM_PRESETS][PRESET_SIZE] = {
    ...
    //Flange-Wha
    {0, 0, 64, 500, 3000, 50, -40, 20000, 1, 0, 196, 96, 0, 0},
    //FbFlange
    {0, 0, 64, 68, 75, 50, -50, 20000, 0, 1, 23, 96, 5, 0},
    //SoftFlange
    {-32, 0, 64, 60, 10, 100, 40, 3267, 0, 0, 16, 90, 4, 0},
    //Flanger
    {-32, 0, 64, 170, 1200, 50, 0, 13200, 1, 0, 68, 127, 0, 0},
    //Preset 6
