...
RBEcho::setpreset (int npreset)
{
  ...
  int presets[NUM_PRESETS][PRESET_SIZE] = {
    ...
    //Echo 3
    {64, 75, 160, 64, 64, 59, 10, 0, 0 ,0 },
    //Simple Echo
    {64, 60, 66, 64, 64, 0, 0, 0, 0 ,0},
    //Canyon
    {32, 64, 1, 50, 32, 20, 22, 32, 0 , 64},
    //Panning Echo 1
    {67, 64, 80, 17, 0, 82, 24, 0, 0 ,64},
    //Panning Echo 2
    {81, 60, 120, 26, 100, 68, 18, 0, 1 ,16},
    //Panning Echo 3
    {81, 60, 240, 42, 127, 67, 36, 0, 2 ,32},
    //Feedback Echo
    {62, 64, 90, 64, 100, 90, 55, 0, 0 ,64}
  };
