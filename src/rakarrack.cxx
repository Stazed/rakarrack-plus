...
convo_LRc->value(rkr->efx_Convol->getpar(5)-64);
...
R average.");
    ...
    { CONVOLOTRON = new Fl_Group(320, 210, 158, 185);
      ...
      { convo_LRc = new SliderW(372, 240, 100, 10, "W/D");
        convo_LRc->type(5);
        ...
        convo_LRc->labelcolor(FL_BACKGROUND2_COLOR);
        convo_LRc->minimum(-64);
        convo_LRc->maximum(63);
        convo_LRc->step(1);
        convo_LRc->textcolor(7);
      ...
      { convo_qual = new SliderW(372, 315, 100, 10, "Quality");
        ...
        convo_qual->labelcolor(FL_BACKGROUND2_COLOR);
        convo_qual->minimum(1);
        convo_qual->maximum(64);
        convo_qual->step(1);
        convo_qual->value(1);
        convo_qual->textcolor(7);
      ...
      { convo_stereo = new Fl_Check_Button(339, 332, 15, 15, "Stereo");
        ...
        convo_stereo->labelcolor(FL_BACKGROUND2_COLOR);
