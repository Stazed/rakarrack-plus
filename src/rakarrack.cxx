...
ryanwah_pan->value(rkr->efx_RyanWah->getpar(1)-64);
...
ryanwah_stdf->value(rkr->efx_RyanWah->getpar(5));
...
void RKRGUI::cb_ryanwah_pan_i(SliderW* o, void*) {
  rkr->efx_RyanWah->changepar(1,(int)(o->value()+64));
}
void RKRGUI::cb_ryanwah_pan(SliderW* o, void* v) {
  ((RKRGUI*)(o->parent()->parent()->user_data()))->cb_ryanwah_pan_i(o,v);
}
...
void RKRGUI::cb_ryanwah_stdf_i(SliderW* o, void*) {
  rkr->efx_RyanWah->changepar(5,(int)o->value());
}
void RKRGUI::cb_ryanwah_stdf(SliderW* o, void* v) {
  ((RKRGUI*)(o->parent()->parent()->user_data()))->cb_ryanwah_stdf_i(o,v);
}
...
R average.");
    ...
    { RYANWAH = new Fl_Group(320, 211, 158, 184);
      ...
      { ryanwah_pan = new SliderW(369, 252, 100, 10, "Pan");
        ryanwah_pan->type(5);
        ryanwah_pan->box(FL_FLAT_BOX);
        ryanwah_pan->color((Fl_Color)178);
        ryanwah_pan->selection_color((Fl_Color)62);
        ryanwah_pan->labeltype(FL_NORMAL_LABEL);
        ryanwah_pan->labelfont(0);
        ryanwah_pan->labelsize(10);
        ryanwah_pan->labelcolor((Fl_Color)FL_BACKGROUND2_COLOR);
        ryanwah_pan->minimum(-64);
        ryanwah_pan->maximum(63);
        ryanwah_pan->step(1);
        ryanwah_pan->textcolor((Fl_Color)FL_BACKGROUND2_COLOR);
        ryanwah_pan->callback((Fl_Callback*)cb_ryanwah_pan);
        ryanwah_pan->align(FL_ALIGN_LEFT);
        ryanwah_pan->when(FL_WHEN_CHANGED);
      } // SliderW* ryanwah_pan
      { ryanwah_freq = new SliderW(369, 264, 100, 10, "Tempo");
        ryanwah_freq->type(5);
      ...
      { ryanwah_rnd = new SliderW(369, 276, 100, 10, "Rnd");
        ryanwah_rnd->type(5);
        ...
        ryanwah_rnd->labelcolor((Fl_Color)FL_BACKGROUND2_COLOR);
        ryanwah_rnd->maximum(127);
        ryanwah_rnd->step(1);
        ryanwah_rnd->textcolor((Fl_Color)FL_BACKGROUND2_COLOR);
        ryanwah_rnd->callback((Fl_Callback*)cb_ryanwah_rnd);
        ryanwah_rnd->align(FL_ALIGN_LEFT);
        ryanwah_rnd->when(FL_WHEN_CHANGED);
      } // SliderW* ryanwah_rnd
      { Fl_Choice* o = ryanwah_lfotype = new Fl_Choice(381, 290, 72, 16, "LFO Type");
      ...
      { ryanwah_stdf = new SliderW(369, 328, 100, 10, "St.df");
        ryanwah_stdf->type(5);
        ryanwah_stdf->box(FL_FLAT_BOX);
        ryanwah_stdf->color((Fl_Color)178);
        ryanwah_stdf->selection_color((Fl_Color)62);
        ryanwah_stdf->labeltype(FL_NORMAL_LABEL);
        ryanwah_stdf->labelfont(0);
        ryanwah_stdf->labelsize(10);
        ryanwah_stdf->labelcolor((Fl_Color)FL_BACKGROUND2_COLOR);
        ryanwah_stdf->maximum(127);
        ryanwah_stdf->step(1);
        ryanwah_stdf->textcolor((Fl_Color)FL_BACKGROUND2_COLOR);
        ryanwah_stdf->callback((Fl_Callback*)cb_ryanwah_stdf);
        ryanwah_stdf->align(FL_ALIGN_LEFT);
        ryanwah_stdf->when(FL_WHEN_CHANGED);
      } // SliderW* ryanwah_stdf
      { ryanwah_dpth = new SliderW(369, 340, 100, 10, "Depth");
        ryanwah_dpth->type(5);
      ...
      { ryanwah_ampsns = new SliderW(369, 352, 100, 10, "Amp.S.");
      ...
      { ryanwah_ampsnsinv = new SliderW(369, 364, 100, 10, "Wah");
      ...
      { ryanwah_smooth = new SliderW(369, 376, 100, 10, "Smooth");
