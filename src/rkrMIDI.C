...
RKR::MIDI_control()
{
    ...
    {
        "Balance FX%", NTS(MC_Balance_FX).c_str(), NTS(EFX_MASTER).c_str(),
        "Input Volume", NTS(MC_Input_Volume).c_str(), NTS(EFX_MASTER).c_str(),
        "Output Volume", NTS(MC_Output_Volume).c_str(), NTS(EFX_MASTER).c_str(),
        "Multi On/Off", NTS(MC_Multi_On_Off).c_str(), NTS(EFX_MASTER).c_str(),

        "Alienwah Dry/Wet", NTS(MC_Alien_DryWet).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Pan", NTS(MC_Alien_Pan).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Tempo", NTS(MC_Alien_LFO_Tempo).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Random", NTS(MC_Alien_LFO_Random).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah LFO Type", NTS(MC_Alien_LFO_Type).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Phase", NTS(MC_Alien_Phase).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Stereo Df.", NTS(MC_Alien_LFO_Stereo).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Depth", NTS(MC_Alien_Depth).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Delay", NTS(MC_Alien_Delay).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah Feedback", NTS(MC_Alien_Feedback).c_str(), NTS(EFX_ALIENWAH).c_str(),
        "Alienwah L/R Cross", NTS(MC_Alien_LR_Cross).c_str(), NTS(EFX_ALIENWAH).c_str(),

        "Analog Phaser Dry/Wet", NTS(MC_APhase_DryWet).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser LFO Type", NTS(MC_APhase_LFO_Type).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser Tempo", NTS(MC_APhase_LFO_Tempo).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser P. Depth", NTS(MC_APhase_Depth).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser Width", NTS(MC_APhase_Width).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser Feedback", NTS(MC_APhase_Feedback).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser Mismatch", NTS(MC_APhase_Mismatch).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser Distortion", NTS(MC_APhase_Distortion).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser Random", NTS(MC_APhase_LFO_Random).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),
        "Analog Phaser Stereo Df.", NTS(MC_APhase_LFO_Stereo).c_str(), NTS(EFX_ANALOG_PHASER).c_str(),

        "Arpie Dry/Wet", NTS(MC_Arpie_DryWet).c_str(), NTS(EFX_ARPIE).c_str(),
        "Arpie Arpe's", NTS(MC_Arpie_ArpeWD).c_str(), NTS(EFX_ARPIE).c_str(),
        "Arpie Pan", NTS(MC_Arpie_Pan).c_str(), NTS(EFX_ARPIE).c_str(),
        "Arpie Tempo", NTS(MC_Arpie_Tempo).c_str(), NTS(EFX_ARPIE).c_str(),
        "Arpie L/R Delay", NTS(MC_Arpie_LR_Delay).c_str(), NTS(EFX_ARPIE).c_str(),
        "Arpie L/R Cross", NTS(MC_Arpie_LR_Cross).c_str(), NTS(EFX_ARPIE).c_str(),
        "Arpie Feedback", NTS(MC_Arpie_Feedback).c_str(), NTS(EFX_ARPIE).c_str(),
        "Arpie Damp", NTS(MC_Arpie_Damp).c_str(), NTS(EFX_ARPIE).c_str(),

        "Cabinet Gain",NTS(MC_Cabinet_Gain).c_str(), NTS(EFX_CABINET).c_str(),

        "Chorus Dry/Wet", NTS(MC_Chorus_DryWet).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus Pan", NTS(MC_Chorus_Pan).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus Tempo", NTS(MC_Chorus_LFO_Tempo).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus Random", NTS(MC_Chorus_LFO_Random).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus LFO Type", NTS(MC_Chorus_LFO_Type).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus Stereo Df", NTS(MC_Chorus_LFO_Stereo).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus Depth", NTS(MC_Chorus_Depth).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus Delay", NTS(MC_Chorus_Delay).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus Feedback", NTS(MC_Chorus_Feedback).c_str(), NTS(EFX_CHORUS).c_str(),
        "Chorus L/R Cross", NTS(MC_Chorus_LR_Cross).c_str(), NTS(EFX_CHORUS).c_str(),

        "CoilCrafter Gain", NTS(MC_Coil_Gain).c_str(), NTS(EFX_COILCRAFTER).c_str(),
        "CoilCrafter Tone", NTS(MC_Coil_Tone).c_str(), NTS(EFX_COILCRAFTER).c_str(),
        "CoilCrafter Freq 1", NTS(MC_Coil_Freq_1).c_str(), NTS(EFX_COILCRAFTER).c_str(),
        "CoilCrafter Q 1", NTS(MC_Coil_Q_1).c_str(), NTS(EFX_COILCRAFTER).c_str(),
        "CoilCrafter Freq 2", NTS(MC_Coil_Freq_2).c_str(), NTS(EFX_COILCRAFTER).c_str(),
        "CoilCrafter Q 2", NTS(MC_Coil_Q_2).c_str(), NTS(EFX_COILCRAFTER).c_str(),

        "CompBand Dry/Wet", NTS(MC_CompBand_DryWet).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand Gain", NTS(MC_CompBand_Gain).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand L Ratio", NTS(MC_CompBand_Low_Ratio).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand ML Ratio", NTS(MC_CompBand_Mid_1_Ratio).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand MH Ratio", NTS(MC_CompBand_Mid_2_Ratio).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand H Ratio", NTS(MC_CompBand_High_Ratio).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand L Thres", NTS(MC_CompBand_Low_Thresh).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand ML Thres", NTS(MC_CompBand_Mid_1_Thresh).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand MH Thres", NTS(MC_CompBand_Mid_2_Thresh).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand H Thres", NTS(MC_CompBand_High_Thresh).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand Cross 1", NTS(MC_CompBand_Cross_1).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand Cross 2", NTS(MC_CompBand_Cross_2).c_str(), NTS(EFX_COMPBAND).c_str(),
        "CompBand Cross 3", NTS(MC_CompBand_Cross_3).c_str(), NTS(EFX_COMPBAND).c_str(),

        "Compressor A.Time", NTS(MC_Compress_Attack).c_str(), NTS(EFX_COMPRESSOR).c_str(),
        "Compressor Knee", NTS(MC_Compress_Knee).c_str(), NTS(EFX_COMPRESSOR).c_str(),
        "Compressor Output", NTS(MC_Compress_Output).c_str(), NTS(EFX_COMPRESSOR).c_str(),
        "Compressor Ratio", NTS(MC_Compress_Ratio).c_str(), NTS(EFX_COMPRESSOR).c_str(),
        "Compressor R.Time", NTS(MC_Compress_Release).c_str(), NTS(EFX_COMPRESSOR).c_str(),
        "Compressor Threshold", NTS(MC_Compress_Threshold).c_str(), NTS(EFX_COMPRESSOR).c_str(),

        "Convolotron Dry/Wet", NTS(MC_Convo_DryWet).c_str(), NTS(EFX_CONVOLOTRON).c_str(),
        "Convolotron Pan", NTS(MC_Convo_Pan).c_str(), NTS(EFX_CONVOLOTRON).c_str(),
        "Convolotron Level", NTS(MC_Convo_Level).c_str(), NTS(EFX_CONVOLOTRON).c_str(),
        "Convolotron Damp", NTS(MC_Convo_Damp).c_str(), NTS(EFX_CONVOLOTRON).c_str(),
        "Convolotron Feedback", NTS(MC_Convo_Feedback).c_str(), NTS(EFX_CONVOLOTRON).c_str(),
        "Convolotron Length", NTS(MC_Convo_Length).c_str(), NTS(EFX_CONVOLOTRON).c_str(),

        "Derelict Dry/Wet", NTS(MC_Dere_DryWet).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict L/R Cross", NTS(MC_Dere_LR_Cross).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict Drive", NTS(MC_Dere_Drive).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict Level", NTS(MC_Dere_Level).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict Type", NTS(MC_Dere_Type).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict Color", NTS(MC_Dere_Color).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict Sub Octave", NTS(MC_Dere_Suboctave).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict Pan", NTS(MC_Dere_Pan).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict LPF", NTS(MC_Dere_LPF).c_str(), NTS(EFX_DERELICT).c_str(),
        "Derelict HPF", NTS(MC_Dere_HPF).c_str(), NTS(EFX_DERELICT).c_str(),

        "DistBand Dry/Wet", NTS(MC_DistBand_DryWet).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand L/R Cross", NTS(MC_DistBand_LR_Cross).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Drive", NTS(MC_DistBand_Drive).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Level", NTS(MC_DistBand_Level).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand L. Gain", NTS(MC_DistBand_Gain_Low).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand M. Gain", NTS(MC_DistBand_Gain_Mid).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand H. Gain", NTS(MC_DistBand_Gain_Hi).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Cross 1", NTS(MC_DistBand_Cross_1).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Cross 2", NTS(MC_DistBand_Cross_2).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Type Low", NTS(MC_DistBand_Type_Low).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Type Mid", NTS(MC_DistBand_Type_Mid).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Type High", NTS(MC_DistBand_Type_Hi).c_str(), NTS(EFX_DISTBAND).c_str(),
        "DistBand Pan", NTS(MC_DistBand_Pan).c_str(), NTS(EFX_DISTBAND).c_str(),

        "Distortion Dry/Wet", NTS(MC_Dist_DryWet).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion L/R Cross", NTS(MC_Dist_LR_Cross).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion Drive", NTS(MC_Dist_Drive).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion Level", NTS(MC_Dist_Level).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion Type", NTS(MC_Dist_Type).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion Pan", NTS(MC_Dist_Pan).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion Sub Octave", NTS(MC_Dist_Suboctave).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion LPF", NTS(MC_Dist_LPF).c_str(), NTS(EFX_DISTORTION).c_str(),
        "Distortion HPF", NTS(MC_Dist_HPF).c_str(), NTS(EFX_DISTORTION).c_str(),

        "Dual Flange Dry/Wet", NTS(MC_DFlange_DryWet).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Pan", NTS(MC_DFlange_Pan).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange L/R Cross", NTS(MC_DFlange_LR_Cross).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Depth", NTS(MC_DFlange_Depth).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Width", NTS(MC_DFlange_Width).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Offset", NTS(MC_DFlange_Offset).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Feedback", NTS(MC_DFlange_Feedback).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange LPF", NTS(MC_DFlange_LPF).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Tempo", NTS(MC_DFlange_LFO_Tempo).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Stereo Df", NTS(MC_DFlange_LFO_Stereo).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange LFO Type", NTS(MC_DFlange_LFO_Type).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),
        "Dual Flange Random", NTS(MC_DFlange_LFO_Random).c_str(), NTS(EFX_DUAL_FLANGE).c_str(),

        "Echo Dry/Wet", NTS(MC_Echo_DryWet).c_str(), NTS(EFX_ECHO).c_str(),
        "Echo Reverse", NTS(MC_Echo_Reverse).c_str(), NTS(EFX_ECHO).c_str(),
        "Echo Pan", NTS(MC_Echo_Pan).c_str(), NTS(EFX_ECHO).c_str(),
        "Echo Delay", NTS(MC_Echo_Delay).c_str(), NTS(EFX_ECHO).c_str(),
        "Echo L/R Delay", NTS(MC_Echo_LR_Delay).c_str(), NTS(EFX_ECHO).c_str(),
        "Echo L/R Cross", NTS(MC_Echo_LR_Cross).c_str(), NTS(EFX_ECHO).c_str(),
        "Echo Feedback", NTS(MC_Echo_Feedback).c_str(), NTS(EFX_ECHO).c_str(),
        "Echo Damp", NTS(MC_Echo_Damp).c_str(), NTS(EFX_ECHO).c_str(),

        "Echotron Dry/Wet", NTS(MC_Echotron_DryWet).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron Pan", NTS(MC_Echotron_Pan).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron Tempo", NTS(MC_Echotron_Tempo).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron Damp", NTS(MC_Echotron_Damp).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron Feedback", NTS(MC_Echotron_Feedback).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron L/R Cross", NTS(MC_Echotron_LR_Cross).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron Width", NTS(MC_Echotron_LFO_Width).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron Depth", NTS(MC_Echotron_Depth).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron Stereo Df", NTS(MC_Echotron_LFO_Stereo).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron LFO Type", NTS(MC_Echotron_LFO_Type).c_str(), NTS(EFX_ECHOTRON).c_str(),
        "Echotron #", NTS(MC_Echotron_Taps).c_str(), NTS(EFX_ECHOTRON).c_str(),

        "Echoverse Dry/Wet", NTS(MC_Echoverse_DryWet).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse Reverse", NTS(MC_Echoverse_Reverse).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse Pan", NTS(MC_Echoverse_Pan).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse Tempo", NTS(MC_Echoverse_Tempo).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse L/R Delay", NTS(MC_Echoverse_LR_Delay).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse Feedback", NTS(MC_Echoverse_Feedback).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse Damp", NTS(MC_Echoverse_Damp).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse Ex Stereo", NTS(MC_Echoverse_Ext_Stereo).c_str(), NTS(EFX_ECHOVERSE).c_str(),
        "Echoverse Angle", NTS(MC_Echoverse_Angle).c_str(), NTS(EFX_ECHOVERSE).c_str(),

        "EQ Gain", NTS(MC_EQ_Gain).c_str(), NTS(EFX_EQ).c_str(),
        "EQ Q", NTS(MC_EQ_Q).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 31 Hz", NTS(MC_EQ_31_HZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 63 Hz", NTS(MC_EQ_63_HZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 125 Hz", NTS(MC_EQ_125_HZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 250 Hz", NTS(MC_EQ_250_HZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 500 Hz", NTS(MC_EQ_500_HZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 1 Khz", NTS(MC_EQ_1_KHZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 2 Khz", NTS(MC_EQ_2_KHZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 4 Khz", NTS(MC_EQ_4_KHZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 8 Khz", NTS(MC_EQ_8_KHZ).c_str(), NTS(EFX_EQ).c_str(),
        "EQ 16 Khz", NTS(MC_EQ_16_KHZ).c_str(), NTS(EFX_EQ).c_str(),

        "Exciter Gain", NTS(MC_Exciter_Gain).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter LPF", NTS(MC_Exciter_LPF).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter HPF", NTS(MC_Exciter_HPF).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 1", NTS(MC_Exciter_Harm_1).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 2", NTS(MC_Exciter_Harm_2).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 3", NTS(MC_Exciter_Harm_3).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 4", NTS(MC_Exciter_Harm_4).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 5", NTS(MC_Exciter_Harm_5).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 6", NTS(MC_Exciter_Harm_6).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 7", NTS(MC_Exciter_Harm_7).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 8", NTS(MC_Exciter_Harm_8).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 9", NTS(MC_Exciter_Harm_9).c_str(), NTS(EFX_EXCITER).c_str(),
        "Exciter Har 10", NTS(MC_Exciter_Harm_10).c_str(), NTS(EFX_EXCITER).c_str(),

        "Expander A.Time", NTS(MC_Expander_Attack).c_str(), NTS(EFX_EXPANDER).c_str(),
        "Expander R.Time", NTS(MC_Expander_Release).c_str(), NTS(EFX_EXPANDER).c_str(),
        "Expander Shape", NTS(MC_Expander_Shape).c_str(), NTS(EFX_EXPANDER).c_str(),
        "Expander Threshold", NTS(MC_Expander_Threshold).c_str(), NTS(EFX_EXPANDER).c_str(),
        "Expander Out Gain", NTS(MC_Expander_Gain).c_str(), NTS(EFX_EXPANDER).c_str(),
        "Expander LPF", NTS(MC_Expander_LPF).c_str(), NTS(EFX_EXPANDER).c_str(),
        "Expander HPF", NTS(MC_Expander_HPF).c_str(), NTS(EFX_EXPANDER).c_str(),

        "Flanger Dry/Wet", NTS(MC_Flanger_DryWet).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger Pan", NTS(MC_Flanger_Pan).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger Tempo", NTS(MC_Flanger_LFO_Tempo).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger Random", NTS(MC_Flanger_LFO_Random).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger LFO Type", NTS(MC_Flanger_LFO_Type).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger Stereo Df", NTS(MC_Flanger_LFO_Stereo).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger Depth", NTS(MC_Flanger_Depth).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger Delay", NTS(MC_Flanger_Delay).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger Feedback", NTS(MC_Flanger_Feedback).c_str(), NTS(EFX_FLANGER).c_str(),
        "Flanger L/R Cross", NTS(MC_Flanger_LR_Cross).c_str(), NTS(EFX_FLANGER).c_str(),

        "Harmonizer Dry/Wet", NTS(MC_Harm_DryWet).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Interval", NTS(MC_Harm_Interval).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Gain", NTS(MC_Harm_Gain).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Pan", NTS(MC_Harm_Pan).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Freq", NTS(MC_Harm_Filter_Freq).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Filter Gain", NTS(MC_Harm_Filter_Gain).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Filter Q", NTS(MC_Harm_Filter_Q).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer SELECT", NTS(MC_Harm_Select).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Note", NTS(MC_Harm_Note).c_str(), NTS(EFX_HARMONIZER).c_str(),
        "Harmonizer Chord", NTS(MC_Harm_Chord).c_str(), NTS(EFX_HARMONIZER).c_str(),

        "Infinity Dry/Wet", NTS(MC_Infinity_DryWet).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Res", NTS(MC_Infinity_Resonance).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 1", NTS(MC_Infinity_Band_1).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 2", NTS(MC_Infinity_Band_2).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 3", NTS(MC_Infinity_Band_3).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 4", NTS(MC_Infinity_Band_4).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 5", NTS(MC_Infinity_Band_5).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 6", NTS(MC_Infinity_Band_6).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 7", NTS(MC_Infinity_Band_7).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Filter Band 8", NTS(MC_Infinity_Band_8).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity AutoPan", NTS(MC_Infinity_AutoPan).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Stereo Df", NTS(MC_Infinity_LR_Delay).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Start", NTS(MC_Infinity_Start).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity End", NTS(MC_Infinity_End).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Tempo", NTS(MC_Infinity_Tempo).c_str(), NTS(EFX_INFINITY).c_str(),
        "Infinity Subdiv", NTS(MC_Infinity_Subdivision).c_str(), NTS(EFX_INFINITY).c_str(),

        "Looper Dry/Wet", NTS(MC_Looper_DryWet).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Level 1", NTS(MC_Looper_Level_1).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Level 2", NTS(MC_Looper_Level_2).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Tempo", NTS(MC_Looper_Tempo).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Reverse", NTS(MC_Looper_Reverse).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Auto Play", NTS(MC_Looper_AutoPlay).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Play", NTS(MC_Looper_Play).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Pause", NTS(MC_Looper_Stop).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Record", NTS(MC_Looper_Record).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper R1", NTS(MC_Looper_Rec_1).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper R2", NTS(MC_Looper_Rec_2).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Track 1", NTS(MC_Looper_Track_1).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Track 2", NTS(MC_Looper_Track_2).c_str(), NTS(EFX_LOOPER).c_str(),
        "Looper Clear", NTS(MC_Looper_Clear).c_str(), NTS(EFX_LOOPER).c_str(),

        "Musical Delay Dry/Wet", NTS(MC_Music_DryWet).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay L/R Cross", NTS(MC_Music_LR_Cross).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay Pan 1", NTS(MC_Music_Pan_1).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay Pan 2", NTS(MC_Music_Pan_2).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay Tempo", NTS(MC_Music_Tempo).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay Gain 1", NTS(MC_Music_Gain_1).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay Gain 2", NTS(MC_Music_Gain_2).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay FB 1", NTS(MC_Music_Feedback_1).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay FB 2", NTS(MC_Music_Feedback_2).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),
        "Musical Delay Damp", NTS(MC_Music_Damp).c_str(), NTS(EFX_MUSICAL_DELAY).c_str(),

        "MuTroMojo Dry/Wet", NTS(MC_MuTro_DryWet).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo LP", NTS(MC_MuTro_LowPass).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo BP", NTS(MC_MuTro_BandPass).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo HP", NTS(MC_MuTro_HighPass).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo LFO Type", NTS(MC_MuTro_LFO_Type).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Depth", NTS(MC_MuTro_Depth).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Tempo", NTS(MC_MuTro_LFO_Tempo).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Res", NTS(MC_MuTro_Resonance).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Range", NTS(MC_MuTro_Range).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Wah", NTS(MC_MuTro_Wah).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo E. Sens", NTS(MC_MuTro_Env_Sens).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Smooth", NTS(MC_MuTro_Env_Smooth).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Random", NTS(MC_MuTro_LFO_Random).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo Stereo Df", NTS(MC_MuTro_LFO_Stereo).c_str(), NTS(EFX_MUTROMOJO).c_str(),
        "MuTroMojo St. Freq", NTS(MC_MuTro_St_Freq).c_str(), NTS(EFX_MUTROMOJO).c_str(),

        "NoiseGate A. Time", NTS(MC_Gate_Attack).c_str(), NTS(EFX_NOISEGATE).c_str(),
        "NoiseGate R. Time", NTS(MC_Gate_Release).c_str(), NTS(EFX_NOISEGATE).c_str(),
        "NoiseGate Range", NTS(MC_Gate_Range).c_str(), NTS(EFX_NOISEGATE).c_str(),
        "NoiseGate Threshold", NTS(MC_Gate_Threshold).c_str(), NTS(EFX_NOISEGATE).c_str(),
        "NoiseGate Hold", NTS(MC_Gate_Hold).c_str(), NTS(EFX_NOISEGATE).c_str(),
        "NoiseGate LPF", NTS(MC_Gate_LPF).c_str(), NTS(EFX_NOISEGATE).c_str(),
        "NoiseGate HPF", NTS(MC_Gate_HPF).c_str(), NTS(EFX_NOISEGATE).c_str(),

        "Opticaltrem Depth", NTS(MC_Optical_Depth).c_str(), NTS(EFX_OPTICALTREM).c_str(),
        "Opticaltrem Tempo", NTS(MC_Optical_LFO_Tempo).c_str(), NTS(EFX_OPTICALTREM).c_str(),
        "Opticaltrem Random", NTS(MC_Optical_LFO_Random).c_str(), NTS(EFX_OPTICALTREM).c_str(),
        "Opticaltrem LFO Type", NTS(MC_Optical_LFO_Type).c_str(), NTS(EFX_OPTICALTREM).c_str(),
        "Opticaltrem Stereo Df", NTS(MC_Optical_LFO_Stereo).c_str(), NTS(EFX_OPTICALTREM).c_str(),
        "Opticaltrem Pan", NTS(MC_Optical_Pan).c_str(), NTS(EFX_OPTICALTREM).c_str(),

        "Overdrive Dry/Wet", NTS(MC_Overdrive_DryWet).c_str(), NTS(EFX_OVERDRIVE).c_str(),
        "Overdrive L/R Cross", NTS(MC_Overdrive_LR_Cross).c_str(), NTS(EFX_OVERDRIVE).c_str(),
        "Overdrive Drive", NTS(MC_Overdrive_Drive).c_str(), NTS(EFX_OVERDRIVE).c_str(),
        "Overdrive Level", NTS(MC_Overdrive_Level).c_str(), NTS(EFX_OVERDRIVE).c_str(),
        "Overdrive Type", NTS(MC_Overdrive_Type).c_str(), NTS(EFX_OVERDRIVE).c_str(),
        "Overdrive Pan", NTS(MC_Overdrive_Pan).c_str(), NTS(EFX_OVERDRIVE).c_str(),
        "Overdrive LPF", NTS(MC_Overdrive_LPF).c_str(), NTS(EFX_OVERDRIVE).c_str(),
        "Overdrive HPF", NTS(MC_Overdrive_HPF).c_str(), NTS(EFX_OVERDRIVE).c_str(),

        "Pan Dry/Wet", NTS(MC_Pan_DryWet).c_str(), NTS(EFX_PAN).c_str(),
        "Pan Pan", NTS(MC_Pan_Pan).c_str(), NTS(EFX_PAN).c_str(),
        "Pan Tempo", NTS(MC_Pan_LFO_Tempo).c_str(), NTS(EFX_PAN).c_str(),
        "Pan Random", NTS(MC_Pan_LFO_Random).c_str(), NTS(EFX_PAN).c_str(),
        "Pan LFO Type", NTS(MC_Pan_LFO_Type).c_str(), NTS(EFX_PAN).c_str(),
        "Pan Stereo Df", NTS(MC_Pan_LFO_Stereo).c_str(), NTS(EFX_PAN).c_str(),
        "Pan E. Stereo", NTS(MC_Pan_Ex_St_Amt).c_str(), NTS(EFX_PAN).c_str(),

        "Parametric EQ Gain", NTS(MC_Parametric_Gain).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ Low Freq", NTS(MC_Parametric_Low_Freq).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ Low Gain", NTS(MC_Parametric_Low_Gain).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ Low Q", NTS(MC_Parametric_Low_Q).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ Mid Freq", NTS(MC_Parametric_Mid_Freq).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ Mid Gain", NTS(MC_Parametric_Mid_Gain).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ Mid Q", NTS(MC_Parametric_Mid_Q).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ High Freq", NTS(MC_Parametric_High_Freq).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ High Gain", NTS(MC_Parametric_High_Gain).c_str(), NTS(EFX_PARAMETRIC).c_str(),
        "Parametric EQ High Q", NTS(MC_Parametric_High_Q).c_str(), NTS(EFX_PARAMETRIC).c_str(),

        "Phaser Dry/Wet", NTS(MC_Phaser_DryWet).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser Pan", NTS(MC_Phaser_Pan).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser Tempo", NTS(MC_Phaser_LFO_Tempo).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser Random", NTS(MC_Phaser_LFO_Random).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser LFO Type", NTS(MC_Phaser_LFO_Type).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser Phase", NTS(MC_Phaser_Phase).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser Stereo Df", NTS(MC_Phaser_LFO_Stereo).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser Depth", NTS(MC_Phaser_Depth).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser Feedback", NTS(MC_Phaser_Feedback).c_str(), NTS(EFX_PHASER).c_str(),
        "Phaser L/R Cross", NTS(MC_Phaser_LR_Cross).c_str(), NTS(EFX_PHASER).c_str(),

        "Reverb Dry/Wet", NTS(MC_Reverb_DryWet).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb Pan", NTS(MC_Reverb_Pan).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb Time", NTS(MC_Reverb_Time).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb Initial Delay", NTS(MC_Reverb_I_Delay).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb Del. E/R", NTS(MC_Reverb_Delay_FB).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb Room Size", NTS(MC_Reverb_Room).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb LPF", NTS(MC_Reverb_LPF).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb HPF", NTS(MC_Reverb_HPF).c_str(), NTS(EFX_REVERB).c_str(),
        "Reverb Damping", NTS(MC_Reverb_Damp).c_str(), NTS(EFX_REVERB).c_str(),

        "Reverbtron Dry/Wet", NTS(MC_Revtron_DryWet).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Pan", NTS(MC_Revtron_Pan).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Level", NTS(MC_Revtron_Level).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Damp", NTS(MC_Revtron_Damp).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Feedback", NTS(MC_Revtron_Feedback).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Length", NTS(MC_Revtron_Length).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Stretch", NTS(MC_Revtron_Stretch).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Initial Delay", NTS(MC_Revtron_I_Delay).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Fade", NTS(MC_Revtron_Fade).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron Diffusion", NTS(MC_Revtron_Diffusion).c_str(), NTS(EFX_REVERBTRON).c_str(),
        "Reverbtron LPF", NTS(MC_Revtron_LPF).c_str(), NTS(EFX_REVERBTRON).c_str(),

        "Ring Dry/Wet", NTS(MC_Ring_DryWet).c_str(), NTS(EFX_RING).c_str(),
        "Ring L/R Cross", NTS(MC_Ring_LR_Cross).c_str(), NTS(EFX_RING).c_str(),
        "Ring Input", NTS(MC_Ring_Input).c_str(), NTS(EFX_RING).c_str(),
        "Ring Level", NTS(MC_Ring_Level).c_str(), NTS(EFX_RING).c_str(),
        "Ring Pan", NTS(MC_Ring_Pan).c_str(), NTS(EFX_RING).c_str(),
        "Ring Depth", NTS(MC_Ring_Depth).c_str(), NTS(EFX_RING).c_str(),
        "Ring Freq", NTS(MC_Ring_Freq).c_str(), NTS(EFX_RING).c_str(),
        "Ring Sine", NTS(MC_Ring_Sine).c_str(), NTS(EFX_RING).c_str(),
        "Ring Triangle", NTS(MC_Ring_Triangle).c_str(), NTS(EFX_RING).c_str(),
        "Ring Sawtooth", NTS(MC_Ring_Saw).c_str(), NTS(EFX_RING).c_str(),
        "Ring Square", NTS(MC_Ring_Square).c_str(), NTS(EFX_RING).c_str(),

        "Sequence Dry/Wet", NTS(MC_Sequence_DryWet).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 1", NTS(MC_Sequence_Step_1).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 2", NTS(MC_Sequence_Step_2).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 3", NTS(MC_Sequence_Step_3).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 4", NTS(MC_Sequence_Step_4).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 5", NTS(MC_Sequence_Step_5).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 6", NTS(MC_Sequence_Step_6).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 7", NTS(MC_Sequence_Step_7).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence 8", NTS(MC_Sequence_Step_8).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence Tempo", NTS(MC_Sequence_Tempo).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence Q", NTS(MC_Sequence_Resonance).c_str(), NTS(EFX_SEQUENCE).c_str(),
        "Sequence Stereo Df", NTS(MC_Sequence_Stdf).c_str(), NTS(EFX_SEQUENCE).c_str(),

        "ShelfBoost Gain", NTS(MC_Shelf_Gain).c_str(), NTS(EFX_SHELFBOOST).c_str(),
        "ShelfBoost Level", NTS(MC_Shelf_Level).c_str(), NTS(EFX_SHELFBOOST).c_str(),
        "ShelfBoost Tone", NTS(MC_Shelf_Tone).c_str(), NTS(EFX_SHELFBOOST).c_str(),
        "ShelfBoost Presence", NTS(MC_Shelf_Presence).c_str(), NTS(EFX_SHELFBOOST).c_str(),

        "Shifter Dry/Wet", NTS(MC_Shifter_DryWet).c_str(), NTS(EFX_SHIFTER).c_str(),
        "Shifter Interval", NTS(MC_Shifter_Interval).c_str(), NTS(EFX_SHIFTER).c_str(),
        "Shifter Gain", NTS(MC_Shifter_Gain).c_str(), NTS(EFX_SHIFTER).c_str(),
        "Shifter Pan", NTS(MC_Shifter_Pan).c_str(), NTS(EFX_SHIFTER).c_str(),
        "Shifter Attack", NTS(MC_Shifter_Attack).c_str(), NTS(EFX_SHIFTER).c_str(),
        "Shifter Decay", NTS(MC_Shifter_Decay).c_str(), NTS(EFX_SHIFTER).c_str(),
        "Shifter Threshold", NTS(MC_Shifter_Threshold).c_str(), NTS(EFX_SHIFTER).c_str(),
        "Shifter Whammy", NTS(MC_Shifter_Whammy).c_str(), NTS(EFX_SHIFTER).c_str(),

        "Shuffle Dry/Wet", NTS(MC_Shuffle_DryWet).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle Low Freq", NTS(MC_Shuffle_Freq_L).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle Low Gain", NTS(MC_Shuffle_Gain_L).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle M.L. Freq", NTS(MC_Shuffle_Freq_ML).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle M.L. Gain", NTS(MC_Shuffle_Gain_ML).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle M.H. Freq", NTS(MC_Shuffle_Freq_MH).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle M.H. Gain", NTS(MC_Shuffle_Gain_MH).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle High Freq", NTS(MC_Shuffle_Freq_H).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle High Gain", NTS(MC_Shuffle_Gain_H).c_str(), NTS(EFX_SHUFFLE).c_str(),
        "Shuffle Q", NTS(MC_Shuffle_Width).c_str(), NTS(EFX_SHUFFLE).c_str(),

        "StereoHarm Dry/Wet", NTS(MC_Sharm_DryWet).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Int L", NTS(MC_Sharm_L_Interval).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Chrm L", NTS(MC_Sharm_L_Chroma).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Gain L", NTS(MC_Sharm_L_Gain).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Int R", NTS(MC_Sharm_R_Interval).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Chrm R", NTS(MC_Sharm_R_Chroma).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Gain R", NTS(MC_Sharm_R_Gain).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm L/R Cross", NTS(MC_Sharm_LR_Cross).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm SELECT", NTS(MC_Sharm_Select).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Note", NTS(MC_Sharm_Note).c_str(), NTS(EFX_STEREOHARM).c_str(),
        "StereoHarm Chord", NTS(MC_Sharm_Chord).c_str(), NTS(EFX_STEREOHARM).c_str(),

        "StompBox Level", NTS(MC_Stomp_Level).c_str(), NTS(EFX_STOMPBOX).c_str(),
        "StompBox Gain", NTS(MC_Stomp_Gain).c_str(), NTS(EFX_STOMPBOX).c_str(),
        "StompBox Bias", NTS(MC_Stomp_Bias).c_str(), NTS(EFX_STOMPBOX).c_str(),
        "StompBox Mid", NTS(MC_Stomp_Mid).c_str(), NTS(EFX_STOMPBOX).c_str(),
        "StompBox Tone", NTS(MC_Stomp_Tone).c_str(), NTS(EFX_STOMPBOX).c_str(),
        "StompBox Mode", NTS(MC_Stomp_Mode).c_str(), NTS(EFX_STOMPBOX).c_str(),

        "Sustainer Gain", NTS(MC_Sustain_Gain).c_str(), NTS(EFX_SUSTAINER).c_str(),
        "Sustainer Sustain", NTS(MC_Sustain_Sustain).c_str(), NTS(EFX_SUSTAINER).c_str(),

        "Synthfilter Dry/Wet", NTS(MC_Synthfilter_DryWet).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Distort", NTS(MC_Synthfilter_Distort).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Tempo", NTS(MC_Synthfilter_LFO_Tempo).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Random", NTS(MC_Synthfilter_LFO_Random).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter LFO Type", NTS(MC_Synthfilter_LFO_Type).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Stereo Df", NTS(MC_Synthfilter_LFO_Stereo).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Width", NTS(MC_Synthfilter_Width).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Feedback", NTS(MC_Synthfilter_Feedback).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Depth", NTS(MC_Synthfilter_Depth).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter E.Sens", NTS(MC_Synthfilter_Env_Sens).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter A.Time", NTS(MC_Synthfilter_Attack).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter R.Time", NTS(MC_Synthfilter_Release).c_str(), NTS(EFX_SYNTHFILTER).c_str(),
        "Synthfilter Offset", NTS(MC_Synthfilter_Offset).c_str(), NTS(EFX_SYNTHFILTER).c_str(),

        "Valve Dry/Wet", NTS(MC_Valve_DryWet).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve L/R Cross", NTS(MC_Valve_LR_Cross).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve Pan", NTS(MC_Valve_Pan).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve Level", NTS(MC_Valve_Level).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve Drive", NTS(MC_Valve_Drive).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve Dist", NTS(MC_Valve_Distortion).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve Presence", NTS(MC_Valve_Presence).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve LPF", NTS(MC_Valve_LPF).c_str(), NTS(EFX_VALVE).c_str(),
        "Valve HPF", NTS(MC_Valve_HPF).c_str(), NTS(EFX_VALVE).c_str(),

        "VaryBand Dry/Wet", NTS(MC_VaryBand_DryWet).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand Tempo 1", NTS(MC_VaryBand_LFO_Tempo_1).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand LFO 1 Type", NTS(MC_VaryBand_LFO_Type_1).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand St.df 1", NTS(MC_VaryBand_LFO_Stereo_1).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand Tempo 2", NTS(MC_VaryBand_LFO_Tempo_2).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand LFO 2 Type", NTS(MC_VaryBand_LFO_Type_2).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand St.df 2", NTS(MC_VaryBand_LFO_Stereo_2).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand Cross 1", NTS(MC_VaryBand_Cross_1).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand Cross 2", NTS(MC_VaryBand_Cross_2).c_str(), NTS(EFX_VARYBAND).c_str(),
        "VaryBand Cross 3", NTS(MC_VaryBand_Cross_3).c_str(), NTS(EFX_VARYBAND).c_str(),

        "Vibe Dry/Wet", NTS(MC_Vibe_DryWet).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe Width", NTS(MC_Vibe_Width).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe Depth", NTS(MC_Vibe_Depth).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe Tempo", NTS(MC_Vibe_LFO_Tempo).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe Random", NTS(MC_Vibe_LFO_Random).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe LFO Type", NTS(MC_Vibe_LFO_Type).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe Stereo Df", NTS(MC_Vibe_LFO_Stereo).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe Feedback", NTS(MC_Vibe_Feedback).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe L/R Cross", NTS(MC_Vibe_LR_Cross).c_str(), NTS(EFX_VIBE).c_str(),
        "Vibe Pan", NTS(MC_Vibe_Pan).c_str(), NTS(EFX_VIBE).c_str(),

        "Vocoder Dry/Wet", NTS(MC_Vocoder_DryWet).c_str(), NTS(EFX_VOCODER).c_str(),
        "Vocoder Pan", NTS(MC_Vocoder_Pan).c_str(), NTS(EFX_VOCODER).c_str(),
        "Vocoder Input", NTS(MC_Vocoder_Input).c_str(), NTS(EFX_VOCODER).c_str(),
        "Vocoder Smear", NTS(MC_Vocoder_Smear).c_str(), NTS(EFX_VOCODER).c_str(),
        "Vocoder Q", NTS(MC_Vocoder_Q).c_str(), NTS(EFX_VOCODER).c_str(),
        "Vocoder Ring", NTS(MC_Vocoder_Ring).c_str(), NTS(EFX_VOCODER).c_str(),
        "Vocoder Level", NTS(MC_Vocoder_Level).c_str(), NTS(EFX_VOCODER).c_str(),

        "WahWah Dry/Wet", NTS(MC_WahWah_DryWet).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Pan", NTS(MC_WahWah_Pan).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Tempo", NTS(MC_WahWah_LFO_Tempo).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Random", NTS(MC_WahWah_LFO_Random).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah LFO Type", NTS(MC_WahWah_LFO_Type).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Stereo Df", NTS(MC_WahWah_LFO_Stereo).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Depth", NTS(MC_WahWah_Depth).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Amp S.", NTS(MC_WahWah_Sense).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Amp S.I.", NTS(MC_WahWah_ASI).c_str(), NTS(EFX_WAHWAH).c_str(),
        "WahWah Smooth", NTS(MC_WahWah_Smooth).c_str(), NTS(EFX_WAHWAH).c_str(),
    };
