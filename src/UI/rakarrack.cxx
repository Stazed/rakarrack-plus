...
void RKRGUI::cb_Load_Skin_i(Fl_Menu_*, void*) {
  // If nothing previously set, then default location
      ...
      char *filename = fl_file_chooser("Load Skin:", "(*.rkrs)", chooser_start_location.c_str(), 0);
...
void RKRGUI::cb_ConvertReverb_i(Fl_Menu_*, void*) {
  // If nothing previously set, then default location
      ...
      m_process->Shut_Off_Below_Mouse = 1;
      char *filename = fl_file_chooser("Convert Reverb IR File:", "(*.wav)", chooser_start_location.c_str(), 0);
      m_process->Shut_Off_Below_Mouse = 0;
...
void RKRGUI::cb_ImportPresets_i(Fl_Menu_*, void*) {
  // Set the file chooser to the previous hidden file
      ...
      m_process->Shut_Off_Below_Mouse = 1;
      char *filename = fl_file_chooser("Import Inserted Presets:","(*)", tempfile,0);
      m_process->Shut_Off_Below_Mouse = 0;
...
Fl_Menu_Item RKRGUI::menu_MenuP[] = {
 ...
 {"Import Preset", 'i',  (Fl_Callback*)RKRGUI::cb_Import_Preset, 0, 0, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
 {"Export Preset", 'e',  (Fl_Callback*)RKRGUI::cb_Export_Preset, 0, 128, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
 {"&Load Bank", 0,  (Fl_Callback*)RKRGUI::cb_BankWindow, 0, 0, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
 {"&Save Bank", FL_CTRL|'s',  (Fl_Callback*)RKRGUI::cb_BankWindow1, 0, 128, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
 ...
 {"Exit", FL_CTRL|'x',  (Fl_Callback*)RKRGUI::cb_salir, 0, 0, (uchar)FL_NORMAL_LABEL, 0, 14, 7},
 {0,0,0,0,0,0,0,0,0},
 {"&Bank", 'b',  (Fl_Callback*)RKRGUI::cb_Bank_Menu, 0, 0, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
 {"&Settings", 0,  0, 0, 64, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
 {"Preferences", 'j',  (Fl_Callback*)RKRGUI::cb_Ajustes, 0, 128, (uchar)FL_NORMAL_LABEL, 0, 14, 7},
 {"MIDI Learn", 'l',  (Fl_Callback*)RKRGUI::cb_ML_Menu, 0, 128, (uchar)FL_NORMAL_LABEL, 0, 14, 7},
 {"ACI", 'a',  (Fl_Callback*)RKRGUI::cb_ACI_Menu, 0, 128, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
...
void RKRGUI::cb_import_preset_i(RKR_Button*, void*) {
  // If nothing previously set, then default location
      ...
      m_process->Shut_Off_Below_Mouse = 1;
      char *filename = fl_file_chooser("Import Preset:", "(*.rkr)", chooser_start_location.c_str(), 0);
      m_process->Shut_Off_Below_Mouse = 0;
  ...
  { Principal = new Fl_Double_Window(800, 600);
    ...
    { Presets = new Fl_Group(168, 24, 352, 170);
      ...
      { export_preset_choice = new RKR_Choice(306, 50, 64, 18, "Export");
        ...
        export_preset_choice->box(FL_UP_BOX);
