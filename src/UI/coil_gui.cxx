...
void CoilGui::cb_coil_preset_i(Fl_Choice* o, void* v) {
...
void CoilGui::cb_coil_preset(Fl_Choice* o, void* v) {
...
void CoilGui::cb_coil_origin_i(Fl_Choice* o, void*) {
  rkr->efx_CoilCrafter->changepar(1,(int)o->value());
coil_freq1->value(rkr->efx_CoilCrafter->getpar(3));
coil_q1->value(rkr->efx_CoilCrafter->getpar(4));
}
void CoilGui::cb_coil_origin(Fl_Choice* o, void* v) {
...
void CoilGui::cb_coil_destiny_i(Fl_Choice* o, void*) {
  rkr->efx_CoilCrafter->changepar(2,(int)o->value());
coil_freq2->value(rkr->efx_CoilCrafter->getpar(5));
coil_q2->value(rkr->efx_CoilCrafter->getpar(6));
}
void CoilGui::cb_coil_destiny(Fl_Choice* o, void* v) {
...
{ coil_WD = new SliderW(49, 25, 100, 10, "Gain");
  coil_WD->type(5);
...
{ coil_tone = new SliderW(49, 41, 100, 10, "Tone");
  coil_tone->type(5);
...
{ coil_origin = new Fl_Choice(48, 55, 90, 18, "Origin");
...
{ coil_freq1 = new SliderW(49, 79, 100, 10, "Freq1");
  coil_freq1->type(5);
...
{ coil_q1 = new SliderW(49, 94, 100, 10, "Q1");
  coil_q1->type(5);
...
{ Fl_Choice* o = coil_destiny = new Fl_Choice(48, 107, 90, 18, "Destiny");
...
{ coil_freq2 = new SliderW(49, 132, 100, 10, "Freq2");
  coil_freq2->type(5);
...
{ coil_q2 = new SliderW(50, 147, 100, 10, "Q2");
  coil_q2->type(5);
...
{ coil_mode = new Fl_Check_Button(13, 161, 41, 15, "Pos.");
