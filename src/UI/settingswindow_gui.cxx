...
{ STabs = new RKR_Tabs(0, 0, 530, 580);
  ...
  { AUDIO_SET = new Fl_Group(5, 26, 518, 554, "Audio");
    ...
    { RKR_Check_Button* o = UPSAMPLE_C = new RKR_Check_Button(30, 175, 16, 16, "Master Upsampling");
...
void SettingsWindowGui::update_vocoder_quality() {
  ...
  /* Save current parameters */
  std::vector<int> save_state = m_rkr->Rack_Effects[EFX_VOCODER]->save_parameters();
  ...
  /* Reset parameters */
  m_rkr->Rack_Effects[EFX_VOCODER]->reset_parameters(save_state);
...
void SettingsWindowGui::update_distortion_quality() {
  /* shut off all processing */
    ...
    /* Save current parameters */
    std::vector<int> save_state = m_rkr->Rack_Effects[EFX_DISTORTION]->save_parameters();
    ...
    /* Reset parameters */
    m_rkr->Rack_Effects[EFX_DISTORTION]->reset_parameters(save_state);
