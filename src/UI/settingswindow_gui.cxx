...
{ STabs = new RKR_Tabs(0, 0, 530, 580);
  ...
  { QUALITY_SET = new Fl_Group(5, 26, 518, 554, "Quality");
    ...
    { RKR_Group* o = Wave_Resample = new RKR_Group(30, 370, 470, 164, "Waveshape Resampling");
      ...
      { RKR_Box* o = Dist_Label = new RKR_Box(45, 400, 156, 17, "Distortion Resampling");
      ...
      { RKR_Box* o = Ovrd_Label = new RKR_Box(45, 425, 156, 17, "Overdrive Resampling");
      ...
      { RKR_Box* o = Dere_Label = new RKR_Box(45, 450, 156, 17, "Derelict Resampling");
      ...
      { RKR_Box* o = DBand_Label = new RKR_Box(45, 475, 156, 17, "DistBand Resampling");
      ...
      { RKR_Box* o = Stomp_Label = new RKR_Box(45, 500, 156, 17, "StompBox Resampling");
