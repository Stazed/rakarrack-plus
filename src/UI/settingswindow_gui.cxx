...
void SettingsWindowGui::cb_FSReset_i(RKR_Button*, void*) {
  scheme_ch->value(2);
    ...
    strlcpy(m_process->Config.BackgroundImage,filename, sizeof(m_process->Config.BackgroundImage));
...
strlcpy(m_process->Config.MID,o->text(valor), sizeof(m_process->Config.MID));
else return;
o->select(valor,1);
m_process->Conecta();
}
...
void SettingsWindowGui::cb_UD_Browser_i(RKR_Button*, void*) {
  char *dir;
    ...
    Udir->value(dir);
    strlcpy(m_process->Config.UDirFilename, dir, sizeof(m_process->Config.UDirFilename));
...
void SettingsWindowGui::cb_BF_Browser_i(RKR_Button*, void*) {
  // If nothing previously set, then default location
    ...
    strlcpy(m_process->Config.BankFilename,filename, sizeof(m_process->Config.BankFilename));
...
void SettingsWindowGui::update_convo_quality() {
  ...
  {
      strlcpy(Efx_Convolotron->Filename,filename.c_str(), sizeof(Efx_Convolotron->Filename));
...
void SettingsWindowGui::update_revtron_quality() {
  ...
  {
      strlcpy(Efx_Reverbtron->Filename,filename.c_str(), sizeof(Efx_Reverbtron->Filename));
