...
{ rbecho_WD = new SliderW(53, 27, 100, 10, "Dry/Wet");
  rbecho_WD->type(5);
...
{ rbecho_RV = new SliderW(53, 41, 100, 10, "Reverse");
  rbecho_RV->type(5);
...
{ rbecho_pan = new SliderW(53, 55, 100, 10, "Pan");
  rbecho_pan->type(5);
...
{ rbecho_delay = new SliderW(53, 69, 100, 10, "Tempo");
  rbecho_delay->type(5);
...
{ rbecho_LRdl = new SliderW(53, 83, 100, 10, "L/R Delay");
  rbecho_LRdl->type(5);
...
{ rbecho_fb = new SliderW(53, 97, 100, 10, "Feedback");
  rbecho_fb->type(5);
...
{ rbecho_damp = new SliderW(53, 134, 100, 10, "Damp");
  rbecho_damp->type(5);
...
{ rbecho_es = new SliderW(53, 148, 100, 10, "Ex Stereo");
...
{ rbecho_angle = new SliderW(53, 162, 100, 10, "Angle");
  rbecho_angle->type(5);
