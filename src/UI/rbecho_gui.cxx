...
void RbechoGui::cb_rbecho_preset_i(RKR_Choice* o, void* v) {
...
void RbechoGui::cb_rbecho_preset(RKR_Choice* o, void* v) {
...
void RbechoGui::cb_rbecho_subdiv_i(RKR_Choice* o, void*) {
  rkr->efx_RBEcho->changepar(8,(int)o->value());
}
void RbechoGui::cb_rbecho_subdiv(RKR_Choice* o, void* v) {
...
{ rbecho_preset = new RKR_Choice(77, 4, 76, 18, "Preset");
  rbecho_preset->box(FL_FLAT_BOX);
  rbecho_preset->down_box(FL_BORDER_BOX);
  rbecho_preset->color(FL_BACKGROUND_COLOR);
  rbecho_preset->selection_color(FL_FOREGROUND_COLOR);
  rbecho_preset->labeltype(FL_NORMAL_LABEL);
  rbecho_preset->labelfont(0);
  ...
  rbecho_preset->align(Fl_Align(FL_ALIGN_LEFT));
...
{ RKR_Choice* o = rbecho_subdiv = new RKR_Choice(77, 111, 76, 18, "SubDivision");
  ...
  rbecho_subdiv->color(FL_BACKGROUND_COLOR);
  rbecho_subdiv->selection_color(FL_FOREGROUND_COLOR);
  rbecho_subdiv->labeltype(FL_NORMAL_LABEL);
  rbecho_subdiv->labelfont(0);
  ...
  rbecho_subdiv->align(Fl_Align(FL_ALIGN_LEFT));
