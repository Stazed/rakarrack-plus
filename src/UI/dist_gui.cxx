...
void DistGui::cb_dist_preset(Fl_Choice* o, void* v) {
...
void DistGui::cb_dist_tipo_i(Fl_Choice* o, void*) {
  rkr->efx_Distorsion->changepar(5,(int)o->value());
}
void DistGui::cb_dist_tipo(Fl_Choice* o, void* v) {
...
void DistGui::cb_dist_neg(Fl_Check_Button* o, void* v) {
  ((DistGui*)(o->parent()))->cb_dist_neg_i(o,v);
}

void DistGui::cb_dist_pf_i(Fl_Check_Button* o, void*) {
  rkr->efx_Distorsion->changepar(10,(int)o->value());
}
void DistGui::cb_dist_pf(Fl_Check_Button* o, void* v) {
  ((DistGui*)(o->parent()))->cb_dist_pf_i(o,v);
}

void DistGui::cb_dist_st_i(Fl_Check_Button* o, void*) {
  rkr->efx_Distorsion->changepar(9,(int)o->value());
}
void DistGui::cb_dist_st(Fl_Check_Button* o, void* v) {
...
{ dist_LRc = new SliderW(52, 48, 100, 10, "L/R.Cr");
  dist_LRc->type(5);
...
{ dist_drive = new SliderW(52, 61, 100, 10, "Drive");
  dist_drive->type(5);
...
{ dist_level = new SliderW(52, 75, 100, 10, "Level");
  dist_level->type(5);
...
{ dist_pf = new Fl_Check_Button(9, 108, 67, 15, "Pre Filter");
...
{ dist_st = new Fl_Check_Button(74, 108, 57, 15, "Stereo");
...
{ dist_pan = new SliderW(52, 125, 100, 10, "Pan");
  dist_pan->type(5);
...
{ dist_oct = new SliderW(52, 145, 100, 10, "Sub Octv");
  dist_oct->type(5);
...
{ dist_lpf = new SliderW(52, 157, 100, 10, "LPF");
  dist_lpf->type(5);
...
{ dist_hpf = new SliderW(52, 169, 100, 10, "HPF");
  dist_hpf->type(5);
