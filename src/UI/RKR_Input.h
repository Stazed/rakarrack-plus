//
// "$Id: RKR_Input.H 8864 2011-07-19 04:49:30Z greg.ercolano $"
//
...
/**
  ...
  <P>
  <TABLE WIDTH=90% BORDER=1 SUMMARY="RKR_Input keyboard and mouse bindings.">
    <CAPTION ALIGN=TOP>RKR_Input keyboard and mouse bindings.</CAPTION>
  ...
  <TABLE WIDTH="90%" BORDER="1" SUMMARY="RKR_Input platform specific keyboard bindings.">
    <CAPTION ALIGN=TOP>RKR_Input platform specific keyboard bindings.</CAPTION>
  <TR>
  ...
  */
class FL_EXPORT RKR_Input : public Fl_Input_ {
  int handle_key();
...
//
// End of "$Id: RKR_Input.H 8864 2011-07-19 04:49:30Z greg.ercolano $".
//
