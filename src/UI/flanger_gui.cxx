...
{ flanger_WD = new SliderW(53, 29, 100, 10, "Dry/Wet");
  flanger_WD->type(5);
...
{ flanger_pan = new SliderW(53, 41, 100, 10, "Pan");
  flanger_pan->type(5);
...
{ flanger_freq = new SliderW(54, 53, 100, 10, "Tempo");
  flanger_freq->type(5);
...
{ flanger_rnd = new SliderW(53, 65, 100, 10, "Random");
  flanger_rnd->type(5);
...
{ Fl_Choice* o = flanger_lfotype = new Fl_Choice(78, 77, 72, 16, "LFO Type");
...
{ flanger_stdf = new SliderW(53, 115, 100, 10, "Stereo Df");
  flanger_stdf->type(5);
...
{ flanger_dpth = new SliderW(53, 128, 100, 10, "Depth");
  flanger_dpth->type(5);
...
{ flanger_delay = new SliderW(53, 141, 100, 10, "Delay");
...
{ flanger_fb = new SliderW(53, 154, 100, 10, "Feedback");
  flanger_fb->type(5);
...
{ flanger_LR = new SliderW(53, 168, 100, 10, "L/R Cross");
  flanger_LR->type(5);
