...
flanger_WD->value(Dry_Wet(rkr->efx_Flanger->getpar(Chorus_DryWet)));
flanger_pan->value(rkr->efx_Flanger->getpar(Chorus_Pan)-64);
flanger_freq->value(rkr->efx_Flanger->getpar(Chorus_LFO_Tempo));
flanger_rnd->value(rkr->efx_Flanger->getpar(Chorus_LFO_Random));
flanger_lfotype->value(rkr->efx_Flanger->getpar(Chorus_LFO_Type));
flanger_stdf->value(rkr->efx_Flanger->getpar(Chorus_LFO_Stereo));
flanger_dpth->value(rkr->efx_Flanger->getpar(Chorus_Depth));
flanger_delay->value(rkr->efx_Flanger->getpar(Chorus_Delay));
flanger_fb->value(rkr->efx_Flanger->getpar(Chorus_Feedback));
flanger_LR->value(rkr->efx_Flanger->getpar(Chorus_LR_Cross));
flanger_subs->value(rkr->efx_Flanger->getpar(Chorus_Subtract));
flanger_awesome->value(rkr->efx_Flanger->getpar(Chorus_Intense));
}
...
rkr->efx_Flanger->changepar(Chorus_DryWet,Dry_Wet((int)(o->value())));
}
...
rkr->efx_Flanger->changepar(Chorus_Pan,(int)(o->value()+64));
}
...
rkr->efx_Flanger->changepar(Chorus_LFO_Tempo,(int)o->value());
}
...
rkr->efx_Flanger->changepar(Chorus_LFO_Random,(int)o->value());
}
...
rkr->efx_Flanger->changepar(Chorus_LFO_Type,(int)o->value());
}
...
void FlangerGui::cb_flanger_subs_i(RKR_Check_Button* o, void*) {
  rkr->efx_Flanger->changepar(Chorus_Subtract,(int)o->value());
}
...
void FlangerGui::cb_flanger_awesome_i(RKR_Check_Button* o, void*) {
  rkr->efx_Flanger->changepar(Chorus_Intense,(int)o->value());
}
...
rkr->efx_Flanger->changepar(Chorus_LFO_Stereo,(int)o->value());
}
...
rkr->efx_Flanger->changepar(Chorus_Depth,(int)o->value());
}
...
rkr->efx_Flanger->changepar(Chorus_Delay,(int)o->value());
}
...
rkr->efx_Flanger->changepar(Chorus_Feedback,(int)o->value());
}
...
rkr->efx_Flanger->changepar(Chorus_LR_Cross,(int)(o->value()));
}
