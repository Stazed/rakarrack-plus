...
{ phaser_WD = new SliderW(49, 29, 100, 10, "Wet/Dry");
  phaser_WD->type(5);
...
{ phaser_pan = new SliderW(49, 41, 100, 10, "Pan");
  phaser_pan->type(5);
...
{ phaser_freq = new SliderW(49, 53, 100, 10, "Tempo");
  phaser_freq->type(5);
...
{ phaser_rnd = new SliderW(49, 65, 100, 10, "Rnd");
  phaser_rnd->type(5);
...
{ Fl_Choice* o = phaser_lfotype = new Fl_Choice(60, 77, 72, 16, "LFO Type");
...
{ phaser_phase = new SliderW(49, 110, 100, 10, "Phase");
  phaser_phase->type(5);
...
{ phaser_stdf = new SliderW(49, 121, 100, 10, "St.df");
  phaser_stdf->type(5);
...
{ phaser_dpth = new SliderW(49, 132, 100, 10, "Depth");
  phaser_dpth->type(5);
...
{ phaser_fb = new SliderW(49, 144, 100, 10, "Fb");
  phaser_fb->type(5);
...
{ phaser_LR = new SliderW(49, 171, 100, 10, "L/R.Cr");
  phaser_LR->type(5);
