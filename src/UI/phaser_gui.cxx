...
void PhaserGui::cb_phaser_activar_i(Fl_Light_Button* o, void*) {
...
void PhaserGui::cb_phaser_activar(Fl_Light_Button* o, void* v) {
...
{ phaser_activar = new Fl_Light_Button(5, 4, 34, 18, "On");
...
{ phaser_WD = new SliderW(53, 29, 100, 10, "Dry/Wet");
  phaser_WD->type(5);
...
{ phaser_pan = new SliderW(53, 41, 100, 10, "Pan");
  phaser_pan->type(5);
...
{ phaser_freq = new SliderW(53, 53, 100, 10, "Tempo");
  phaser_freq->type(5);
...
{ phaser_rnd = new SliderW(53, 65, 100, 10, "Random");
  phaser_rnd->type(5);
...
{ phaser_phase = new SliderW(53, 110, 100, 10, "Phase");
  phaser_phase->type(5);
...
{ phaser_stdf = new SliderW(53, 121, 100, 10, "Stereo Df");
...
{ phaser_dpth = new SliderW(53, 132, 100, 10, "Depth");
...
{ phaser_fb = new SliderW(53, 144, 100, 10, "Feedback");
  phaser_fb->type(5);
...
{ phaser_LR = new SliderW(53, 171, 100, 10, "L/R Cross");
  phaser_LR->type(5);
