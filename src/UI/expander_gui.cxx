...
{ expander_ATime = new SliderW(51, 39, 100, 10, "A. Time");
...
{ expander_RTime = new SliderW(50, 61, 100, 10, "R. Time");
...
{ expander_shape = new SliderW(50, 83, 100, 10, "Shape");
...
{ expander_threshold = new SliderW(50, 105, 100, 10, "Thrhold");
...
{ expander_LPF = new SliderW(50, 146, 100, 10, "LPF");
  expander_LPF->type(5);
...
{ expander_HPF = new SliderW(50, 162, 100, 10, "HPF");
  expander_HPF->type(5);
