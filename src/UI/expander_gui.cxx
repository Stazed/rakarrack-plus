...
{ expander_ATime = new SliderW(53, 39, 100, 10, "A. Time");
...
{ expander_RTime = new SliderW(53, 61, 100, 10, "R. Time");
...
{ expander_shape = new SliderW(53, 83, 100, 10, "Shape");
...
{ expander_threshold = new SliderW(53, 105, 100, 10, "Thrhold");
...
{ expander_level = new SliderW(53, 125, 100, 10, "Out Gain");
...
{ expander_LPF = new SliderW(53, 146, 100, 10, "LPF");
  expander_LPF->type(5);
...
{ expander_HPF = new SliderW(53, 162, 100, 10, "HPF");
  expander_HPF->type(5);
