...
void RyanwahGui::cb_ryanwah_preset_i(RKR_Choice* o, void* v) {
...
void RyanwahGui::cb_ryanwah_preset(RKR_Choice* o, void* v) {
...
void RyanwahGui::cb_ryanwah_lfotype_i(RKR_Choice* o, void*) {
  rkr->efx_RyanWah->changepar(4,(int)o->value());
}
void RyanwahGui::cb_ryanwah_lfotype(RKR_Choice* o, void* v) {
...
{ ryanwah_preset = new RKR_Choice(78, 5, 76, 18, "Preset");
  ryanwah_preset->box(FL_FLAT_BOX);
  ryanwah_preset->down_box(FL_BORDER_BOX);
  ryanwah_preset->color(FL_BACKGROUND_COLOR);
  ryanwah_preset->selection_color(FL_FOREGROUND_COLOR);
  ryanwah_preset->labeltype(FL_NORMAL_LABEL);
  ryanwah_preset->labelfont(0);
  ...
  ryanwah_preset->align(Fl_Align(FL_ALIGN_LEFT));
...
{ RKR_Choice* o = ryanwah_lfotype = new RKR_Choice(80, 73, 72, 16, "LFO");
  ryanwah_lfotype->box(FL_FLAT_BOX);
  ryanwah_lfotype->down_box(FL_BORDER_BOX);
  ryanwah_lfotype->color(FL_BACKGROUND_COLOR);
  ryanwah_lfotype->selection_color(FL_FOREGROUND_COLOR);
  ryanwah_lfotype->labeltype(FL_NORMAL_LABEL);
  ryanwah_lfotype->labelfont(0);
  ...
  ryanwah_lfotype->align(Fl_Align(FL_ALIGN_LEFT));
