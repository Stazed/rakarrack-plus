...
convo_WD->value(rkr->efx_Convol->getpar(0));
...
rkr->efx_Convol->changepar(0,(int)(o->value()));
}
...
{ convo_WD = new SliderW(52, 30, 100, 10, "Wet/Dry");
  convo_WD->type(5);
...
{ convo_pan = new SliderW(52, 46, 100, 10, "Pan");
  convo_pan->type(5);
...
{ convo_level = new SliderW(52, 62, 100, 10, "Level");
  convo_level->type(5);
...
{ convo_damp = new SliderW(52, 78, 100, 10, "Damp");
  convo_damp->type(5);
...
{ convo_fb = new SliderW(52, 94, 100, 10, "Fb");
  convo_fb->type(5);
...
{ convo_length = new SliderW(52, 110, 100, 10, "Length");
  convo_length->type(5);
