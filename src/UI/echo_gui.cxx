...
{ echo_RV = new SliderW(51, 58, 100, 10, "Reverse");
  echo_RV->type(5);
...
{ echo_pan = new SliderW(51, 73, 100, 10, "Pan");
  echo_pan->type(5);
...
{ echo_delay = new SliderW(51, 88, 100, 10, "Delay");
  echo_delay->type(5);
...
{ echo_LRdl = new SliderW(51, 103, 100, 10, "LRdl.");
  echo_LRdl->type(5);
...
{ echo_LRc = new SliderW(51, 118, 100, 10, "L/R.Cr");
  echo_LRc->type(5);
...
{ echo_fb = new SliderW(51, 133, 100, 10, "Fb.");
  echo_fb->type(5);
...
{ echo_damp = new SliderW(51, 167, 100, 10, "Damp");
  echo_damp->type(5);
