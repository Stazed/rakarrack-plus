...
void EchoGui::cb_echo_activar_i(Fl_Light_Button* o, void*) {
...
void EchoGui::cb_echo_activar(Fl_Light_Button* o, void* v) {
...
void EchoGui::cb_echo_preset(Fl_Choice* o, void* v) {
...
{ echo_activar = new Fl_Light_Button(5, 4, 34, 18, "On");
...
{ echo_preset = new Fl_Choice(77, 4, 76, 18, "Preset");
...
{ echo_WD = new SliderW(53, 35, 100, 10, "Dry/Wet");
  echo_WD->type(5);
...
{ echo_RV = new SliderW(53, 58, 100, 10, "Reverse");
  echo_RV->type(5);
...
{ echo_pan = new SliderW(53, 73, 100, 10, "Pan");
  echo_pan->type(5);
...
{ echo_delay = new SliderW(53, 88, 100, 10, "Delay");
  echo_delay->type(5);
...
{ echo_LRc = new SliderW(53, 118, 100, 10, "L/R Cross");
  echo_LRc->type(5);
...
{ echo_fb = new SliderW(53, 133, 100, 10, "Feedback");
  echo_fb->type(5);
...
{ echo_damp = new SliderW(53, 167, 100, 10, "Damp");
  echo_damp->type(5);
