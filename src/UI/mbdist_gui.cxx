...
void MbdistGui::cb_mbdist_preset_i(Fl_Choice* o, void* v) {
  long long ud= (long long) v;
if((ud==0)||(ud==12023))rkr->efx_MBDist->setpreset((int)o->value());
mbdist_WD->value(rkr->efx_MBDist->getpar(0));
...
void MbdistGui::cb_mbdist_preset(Fl_Choice* o, void* v) {
...
rkr->efx_MBDist->changepar(0,(int)(o->value()));
}
...
void MbdistGui::cb_mbdist_tipoL_i(Fl_Choice* o, void*) {
  rkr->efx_MBDist->changepar(5,(int)o->value());
}
void MbdistGui::cb_mbdist_tipoL(Fl_Choice* o, void* v) {
  ((MbdistGui*)(o->parent()))->cb_mbdist_tipoL_i(o,v);
}

void MbdistGui::cb_mbdist_tipoM_i(Fl_Choice* o, void*) {
  rkr->efx_MBDist->changepar(6,(int)o->value());
}
void MbdistGui::cb_mbdist_tipoM(Fl_Choice* o, void* v) {
  ((MbdistGui*)(o->parent()))->cb_mbdist_tipoM_i(o,v);
}

void MbdistGui::cb_mbdist_tipoH_i(Fl_Choice* o, void*) {
  rkr->efx_MBDist->changepar(7,(int)o->value());
}
void MbdistGui::cb_mbdist_tipoH(Fl_Choice* o, void* v) {
...
{ mbdist_WD = new SliderW(52, 26, 100, 10, "Wet/Dry");
  mbdist_WD->type(5);
...
{ mbdist_LRc = new SliderW(52, 38, 100, 10, "L/R.Cr");
  mbdist_LRc->type(5);
...
{ mbdist_drive = new SliderW(52, 50, 100, 10, "Drive");
  mbdist_drive->type(5);
...
{ mbdist_level = new SliderW(52, 62, 100, 10, "Level");
  mbdist_level->type(5);
...
{ mbdist_volL = new SliderW(52, 76, 100, 10, "L.Gain");
  mbdist_volL->type(5);
...
{ mbdist_volM = new SliderW(52, 89, 100, 10, "M.Gain");
  mbdist_volM->type(5);
...
{ mbdist_volH = new SliderW(52, 102, 100, 10, "H. Gain");
  mbdist_volH->type(5);
...
{ mbdist_cross1 = new SliderW(52, 115, 100, 10, "Cross1");
...
{ mbdist_cross2 = new SliderW(52, 127, 100, 10, "Cross2");
...
{ Fl_Choice* o = mbdist_tipoL = new Fl_Choice(3, 139, 50, 16);
...
{ Fl_Choice* o = mbdist_tipoM = new Fl_Choice(54, 139, 50, 16);
...
{ Fl_Choice* o = mbdist_tipoH = new Fl_Choice(105, 139, 50, 16);
...
{ mbdist_pan = new SliderW(52, 158, 100, 10, "Pan");
  mbdist_pan->type(5);
