...
Analog_Phaser::setpreset (int npreset)
{
  ...
  int presets[NUM_PRESETS][PRESET_SIZE] = {
    //Phaser1
    {64, 20, 254, 0, 1, 64, 110, 40, 4, 10, 0, 64, 1},
    //Phaser2
    {64, 20, 254, 5, 1, 64, 110, 40, 6, 10, 0, 70, 1},
    //Phaser3
    {64, 20, 422, 0, 0, 64, 40, 40, 8, 10, 0, 60, 0},
    //Phaser4
    {64, 20, 254, 10, 0, 64, 110, 80, 7, 10, 1, 45, 1},
    //Phaser5
    {25, 20, 15, 10, 0, 64, 25, 16, 8, 100, 0, 25, 0},
    //Phaser6
    {64, 20, 600, 10, 1, 64, 110, 40, 12, 10, 0, 70, 1}
  };
