...
Chorus::setpreset (int npreset)
{
  ...
  int presets[NUM_PRESETS][PRESET_SIZE] = {
    //Chorus1
    {64, 64, 110, 0, 0, 90, 40, 85, 64, 119, 0, 0},
    //Chorus2
    {64, 64, 187, 0, 0, 98, 56, 90, 64, 19, 0, 0},
    //Chorus3
    {64, 64, 517, 0, 1, 42, 97, 95, 90, 127, 0, 0},
    //Celeste1
    {64, 64, 600, 0, 0, 42, 115, 18, 90, 127, 0, 0},
    //Celeste2
    {64, 64, 517, 117, 0, 50, 115, 9, 31, 127, 0, 1},
    //Flange1
    {64, 64, 93, 0, 0, 60, 23, 3, 62, 0, 0, 0},
    //Flange2
    {64, 64, 395, 34, 1, 40, 35, 3, 109, 0, 0, 0},
    //Flange3
    {64, 64, 117, 34, 1, 94, 35, 3, 54, 0, 0, 1},
    //Flange4
    {64, 64, 254, 0, 1, 62, 12, 19, 97, 0, 0, 0},
    //Flange5
    {64, 64, 105, 105, 0, 24, 39, 19, 17, 0, 0, 1}
  };
