...
RKR::RKR ()
{
  ...
  efx_Simultron = new Simultron(efxoutl,efxoutr);
...
// Names
...

  {
    static const char *los_names[] =
      ...
      "Sustainer", "Sequence", "Shifter", "StompBox", "Simultron"
    };
      ...
      for (i = 0; i < 10; i++)
	{
	    ...
	    case 23:
	     ...
	     case 40:
              if (Simultron_Bypass)
                {
                  efx_Simultron->out(efxoutl, efxoutr);
		  Vol_Efx(40,efx_Simultron->outvolume);
                }
              break;  
