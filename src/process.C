...
//    RecNote->update_freqs(aFreq); // cannot call here until RecNote is declared, which must be placed after efxoutl, efxoutr initialization
    ...
    efx_APhaser = new Analog_Phaser(efxoutl, efxoutr, fSample_rate, period);
    ...
    efx_Alienwah = new Alienwah (efxoutl, efxoutr, fSample_rate, period);
    ...
    efx_Arpie = new Arpie(efxoutl,efxoutr, fSample_rate, period);
...
RKR::Alg (float *origl, float *origr, void *)
{
    ...
    if (Bypass) {
        ...
        for (i = 0; i < 10; i++) {
            ...
            case 0:
                if (EQ1_Bypass) {
                    efx_EQ1->out (efxoutl, efxoutr, period);
                    Vol2_Efx ();
                }
                break;
            ...
            case 5:
                if (Chorus_Bypass) {
                    efx_Chorus->out (efxoutl, efxoutr, period);
            ...
            case 7:
                if (Flanger_Bypass) {
                    efx_Flanger->out (efxoutl, efxoutr, period);
            ...
            case 9:
                if (EQ2_Bypass) {
                    efx_EQ2->out (efxoutl, efxoutr, period);
                    Vol2_Efx ();
                }
                break;
            ...
            case 12:
                if (Cabinet_Bypass) {
                    efx_Cabinet->out (efxoutl, efxoutr, period);
                    Vol3_Efx ();
                }
            ...
            case 15:
                if (MusDelay_Bypass) {
                    efx_MusDelay->out (efxoutl, efxoutr, period);
            ...
            case 17:
                if(NewDist_Bypass) {
                    efx_NewDist->out (efxoutl, efxoutr, period);
            ...
            case 19:
                if (Valve_Bypass) {
                    efx_Valve->out(efxoutl, efxoutr, period);
            ...
            case 22:
                if (Exciter_Bypass) {
                    efx_Exciter->out(efxoutl, efxoutr, period);
                    Vol2_Efx();
                }
                break;
            ...
            case 25:
                if (Expander_Bypass) {
                    efx_Expander->out(efxoutl, efxoutr, period);
                    Vol2_Efx();
                }
                break;
            ...
            case 26:
                if (Shuffle_Bypass) {
                    efx_Shuffle->out(efxoutl, efxoutr, period);
            ...
            case 27:
                if (Synthfilter_Bypass) {
                    efx_Synthfilter->out(efxoutl, efxoutr, period);
            ...
            case 33:
                if (CoilCrafter_Bypass) {
                    efx_CoilCrafter->out(efxoutl, efxoutr, period);
                    Vol2_Efx();
                }
                break;
            ...
            case 35:
                if (Vocoder_Bypass) {
                    efx_Vocoder->out(efxoutl, efxoutr, period);
            ...
            case 36:
                if (Sustainer_Bypass) {
                    efx_Sustainer->out(efxoutl, efxoutr, period);
                    Vol2_Efx();
                }
                break;
            ...
            case 38:
                if (Shifter_Bypass) {
                    efx_Shifter->out(efxoutl, efxoutr, period);
            ...
            case 40:
                if (Reverbtron_Bypass) {
                    efx_Reverbtron->out(efxoutl, efxoutr, period);
