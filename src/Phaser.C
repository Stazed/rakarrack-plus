...
Phaser::setpreset (int npreset)
{
  ...
  int presets[NUM_PRESETS][PRESET_SIZE] = {
    //Phaser1
    {64, 64, 326, 0, 0, 64, 110, 64, 1, 0, 0, 20},
    //Phaser2
    {64, 64, 348, 0, 0, 88, 40, 64, 3, 0, 0, 20},
    //Phaser3
    {64, 64, 452, 0, 0, 66, 68, 107, 2, 0, 0, 20},
    //Phaser4
    {39, 64, 600, 0, 0, 66, 67, 10, 5, 0, 1, 20},
    //Phaser5
    {64, 64, 600, 0, 1, 110, 67, 78, 10, 0, 0, 20},
    //Phaser6
    {64, 64, 117, 100, 0, 58, 37, 78, 3, 0, 0, 20}
  };
